...
namespace Altom.AltUnityTesterEditor
{
    public class AltUnityTesterEditorWindow : UnityEditor.EditorWindow
    {
        ...
        private static UnityEngine.Texture2D GetOddNumberTestTexture()
        {
            ...
            return oddNumberTestTexture;
        }
        
        private static UnityEngine.Texture2D GetEvenNumberTestTexture()
        {
        ...
        private void ShowAltUnityPopup()
        {
            ...
            UnityEngine.GUI.DrawTexture(popUpContentPosition, GetOddNumberTestTexture());
            ...
            foreach (var test in tests)
            {
                ...
                else
                {
                    if (testCounter % 2 == 0)
                    {
                        ...
                        evenNumberStyle.normal.background = GetEvenNumberTestTexture();
                    ...
                    else
                    {
                        ...
                        oddNumberStyle.normal.background = GetOddNumberTestTexture();
