...
namespace Unity.FPS.AI
{
    ...
    public class EnemyMobile : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.LogErrorIfNullGetComponent<EnemyController, EnemyMobile>(m_EnemyController, this,
                gameObject);
            ...
            DebugUtility.LogErrorIfNullGetComponent<AudioSource, EnemyMobile>(m_AudioSource, this, gameObject);
